    ...
    <section className="min-h-screen flex flex-col justify-center px-6 max-w-5xl mx-auto pt-20">
      <div className="animate-fade-in">
        ...
        <p className="text-muted text-lg max-w-xl leading-relaxed mb-10">
          CS student at Northeastern building things that{' '}
          <span className="text-dark font-medium">move</span>,{' '}
          <span className="text-dark font-medium">think</span>, and{' '}
          <span className="text-dark font-medium">talk</span> — robotics, ML, and full-stack.
        </p>
        ...
        <div className="flex gap-8 text-sm text-muted">
          <a href="https://github.com/Adityaagulatii" target="_blank" rel="noopener noreferrer"
        ...
        <div className="mt-20 grid grid-cols-3 gap-8 max-w-sm">
          {[['3+', 'Years Coding'], ['10+', 'Projects Built'], ['2', 'Internships']].map(([num, label]) => (
            <div key={label}>
