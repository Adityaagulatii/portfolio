...
export default function ProjectCard({ project }) {
  ...
  return (
    ...
    >
      <div className="px-8 md:px-16 lg:px-20 py-8 md:py-10">
        {/* Title row */}
        <div className="flex items-start justify-between gap-6 md:gap-8 mb-3">
          <h3
          ...
          <div className="flex items-center gap-4 shrink-0">
            <div
              className="hidden sm:block w-36 h-24 md:w-48 md:h-28 overflow-hidden transition-all duration-300"
              style={{
            ...
            <span
              className="text-2xl transition-all duration-300 hidden md:block"
        ...
        {/* Tagline — full width below the title row */}
        <p
          className="text-sm leading-relaxed transition-colors duration-300 w-full"
